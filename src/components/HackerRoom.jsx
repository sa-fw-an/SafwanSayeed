...
export function HackerRoom(props) {
  ...
  const materialMonitor = useMemo(() => <meshMatcapMaterial map={monitortxt} />, [monitortxt]);
  const materialScreen = useMemo(() => <meshMatcapMaterial map={screenTxt} />, [screenTxt]);

  const meshes = [
    { geometry: nodes.screen_screens_0.geometry, material: materials.screens, customMaterial: materialScreen },
    ...
    { geometry: nodes.table_table_mat_0_2.geometry, material: materials.computer_mat, customMaterial: materialMonitor },
    ...
    { geometry: nodes.table_table_mat_0_8.geometry, material: materials.tv_mat, customMaterial: materialMonitor },
  ...
  return (
    <group {...props} dispose={null}>
      {meshes.map(({ geometry, material, customMaterial }, index) => (
